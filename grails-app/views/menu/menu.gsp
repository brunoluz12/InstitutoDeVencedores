...
<div id="main">
    ...
    <div class="ym-col3  ym-noprint">
        ...
        <div class="ym-cbox">
            <!-- Formata todo o Menu -->
            <div class="ym-vlist">
                <p class="sidehead">HTML Básico</p>
                <ul>
                    <li><a class="wikilink" href="presencaSemanal">Presença Semanal</a></li>
                    <li><a class="wikilink" href="totalPorEquipe">Total Por Equipe</a></li>
                    <li><a class="wikilink" href="inadimplencia">Inadimplência</a></li>
                    <li><a class="wikilink" href="mediasGerais">Médias Gerais</a></li>
                    <li><a class="wikilink" href="aproveitamentoPorProfessor">Aproveitamento Por Professor</a></li>
                    <li><a class="wikilink" href="aproveitamentoPorEquipe">Aproveitamento Por Equipe</a></li>
                    <li><a class="wikilink" href="alunosPorDiaHorario">Alunos Por Dia/Horário</a></li>
                </ul>
            </div>
        </div>
    </div>
