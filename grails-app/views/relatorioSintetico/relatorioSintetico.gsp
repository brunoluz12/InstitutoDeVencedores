            ...
            <div class="ym-vlist">
                ...
                <ul>
                    ...
                    <li><g:link controller="presencaSemanal"
                                action="presencaSemanal">Presença Semanal</g:link></li>
                    <li><g:link controller="aproveitamentoPorEquipe"
                                action="aproveitamentoPorEquipe">Aproveitamento Por Equipe</g:link></li>
                    <li><g:link controller="aproveitamentoPorProfessor"
                                action="aproveitamentoPorProfessor">Aproveitamento Por Professor</g:link></li>
                    <li><g:link controller="alunosPorDiaHorario"
                                action="alunosPorDiaHorario">Alunos Por Dia/Horario</g:link></li>
                    <li><g:link controller="totalPorEquipe"
                                action="totalPorEquipe">Total Por Equipe</g:link></li>
                    <li><g:link controller="inadimplencia"
                                action="inadimplencia">Inadimplencia</g:link></li>
                    <li><g:link controller="mediasGerais" action="mediasGerais">Médias Gerais</g:link></li>
                </ul>
            </div>
        </div>
    </div>
