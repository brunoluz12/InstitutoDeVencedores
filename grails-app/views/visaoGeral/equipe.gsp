...
<div id="main">
    ...
    <div class="ym-col3  ym-noprint">
        ...
        <div class="ym-cbox">
            <!-- Formata todo o Menu -->
            <div class="ym-vlist">
                <p class="sidehead">Visão Geral</p>
                <ul>
                    <li><g:link controller="visaoGeral"
                                action="equipeConexao">Conexão</g:link></li>
                    <li><g:link controller="visaoGeral"
                                action="equipeGarra">Equipe Garra</g:link></li>
                    <li><g:link controller="visaoGeral"
                                action="equipeEscudeiros">Equipe Escudeiros</g:link></li>
                    <li><g:link controller="visaoGeral"
                                action="equipeHerdeiros">Equipe Herdeiros</g:link></li>
                    <li><g:link controller="visaoGeral"
                                action="equipeEmbaixadores">Equipe Embaixadores</g:link></li>
                </ul>
            </div>
        </div>
    </div>
