            ...
            <div class="ym-vlist">
                ...
                <ul>
                    <li><g:link controller="visaoGeral"
                                action="professorViviane">Viviane Nascente</g:link></li>
                    <li><g:link controller="visaoGeral"
                                action="professorHarley">Harley Sandoval</g:link></li>
                    <li><g:link controller="visaoGeral"
                                action="professorTainara">Tainara</g:link></li>
                    <li><g:link controller="visaoGeral"
                                action="professorAlex">Alex César</g:link></li>
                </ul>
            </div>
        </div>
    </div>
